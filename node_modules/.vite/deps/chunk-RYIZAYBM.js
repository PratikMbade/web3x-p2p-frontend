...
async function createWalletConnectClient(options) {
  ...
  walletConnectClient.on("session_proposal", async (event) => {
    const { onSessionProposal } = await import("./session-proposal-WYJI5OOL.js");
  ...
  walletConnectClient.on("session_request", async (event) => {
    const { fulfillRequest } = await import("./session-request-RHUOZYK7.js");
...
//# sourceMappingURL=chunk-RYIZAYBM.js.map
