import {
  fetchTokenMetadata
} from "./chunk-WV4OOX6X.js";
import {
  parseNFT
} from "./chunk-KGK52DU5.js";
import {
  getNFT
} from "./chunk-IKJTJNVL.js";
import {
  detectMethod
...
async function getNFTFromRPC(options) {
  ...
  const [uri, owner] = await Promise.all([
    ...
    options.includeOwner ? import("./ownerOf-RORDIUZN.js").then((m) => m.ownerOf({ contract: options.contract, tokenId })).catch(() => null) : null
  ]);
...
//# sourceMappingURL=chunk-LTJAQIQV.js.map
