...
async function isOpStackChain(chain) {
  ...
  try {
    const { getChainMetadata } = await import("./utils-DGP3CTQP.js");
...
async function estimateGasCost(options) {
  ...
  if (await isOpStackChain(transaction.chain)) {
    const { estimateL1Fee } = await import("./estimate-l1-fee-HLENYKBA.js");
...
//# sourceMappingURL=chunk-4JDLUM2I.js.map
