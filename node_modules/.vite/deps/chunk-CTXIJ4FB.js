  ...
  return approve({
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals } = await import("./decimals-42LWZUC6.js");
...
async function createSmartAccount(options) {
  ...
  const account = {
    ...
    async signMessage({ message }) {
      ...
      const { smartAccountSignMessage } = await import("./signing-JUKXCNXS.js");
    ...
    async signTypedData(typedData) {
      ...
      const { smartAccountSignTypedData } = await import("./signing-JUKXCNXS.js");
    ...
    sendCalls: async (options2) => {
      const { inAppWalletSendCalls } = await import("./in-app-wallet-calls-OYSYJJ5M.js");
    ...
    getCallsStatus: async (options2) => {
      const { inAppWalletGetCallsStatus } = await import("./in-app-wallet-calls-OYSYJJ5M.js");
      return inAppWalletGetCallsStatus(options2);
    },
    getCallsStatusRaw: async (options2) => {
      const { inAppWalletGetCallsStatusRaw } = await import("./in-app-wallet-calls-OYSYJJ5M.js");
...
//# sourceMappingURL=chunk-CTXIJ4FB.js.map
