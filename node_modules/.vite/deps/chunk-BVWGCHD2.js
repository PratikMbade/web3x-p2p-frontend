...
async function getClaimParams(options) {
  const cc = await (async () => {
    if (options.type === "erc1155") {
      const { getActiveClaimCondition: getActiveClaimCondition2 } = await import("./getActiveClaimCondition-F77GA6OL.js");
    ...
    if (options.type === "erc721") {
      if (options.singlePhaseDrop) {
        const { claimCondition } = await import("./claimCondition-KFOENU7L.js");
        return await claimCondition({
          contract: options.contract
        });
      }
      const { getActiveClaimCondition: getActiveClaimCondition2 } = await import("./getActiveClaimCondition-LYA544O5.js");
      return await getActiveClaimCondition2({
        contract: options.contract
      });
    }
    ...
    const { getActiveClaimCondition } = await import("./getActiveClaimCondition-RFCPKJGX.js");
  ...
  const allowlistProof = await (async () => {
    ...
    const { fetchProofsForClaimer } = await import("./fetch-proofs-for-claimers-XUT545IJ.js");
...
//# sourceMappingURL=chunk-BVWGCHD2.js.map
