...
async function getNFTAsset(options) {
  ...
  switch (true) {
    case erc721: {
      const { getNFT } = await import("./getNFT-VCOHBTSN.js");
      return getNFT(options);
    }
    case erc1155: {
      const { getNFT } = await import("./getNFT-6HU37RND.js");
      return getNFT(options);
    }
    default: {
...
async function isListingValid(options) {
  ...
  if (erc721) {
    const [{ isApprovedForAll }, { getApproved }, { ownerOf }] = await Promise.all([
      import("./isApprovedForAll-OPWMP2EA.js"),
      import("./getApproved-NTW5YJ5O.js"),
      import("./ownerOf-RORDIUZN.js")
    ]);
  ...
  if (erc1155) {
    const [{ isApprovedForAll }, { balanceOf }] = await Promise.all([
      import("./isApprovedForAll-BYXUFTB6.js"),
      import("./balanceOf-LWFNFI4L.js")
    ]);
...
//# sourceMappingURL=chunk-3K6USJE7.js.map
