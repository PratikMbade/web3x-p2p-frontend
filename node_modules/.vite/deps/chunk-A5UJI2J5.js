...
async function getWalletBalance(options) {
  ...
  if (tokenAddress && getAddress(tokenAddress) !== getAddress(NATIVE_TOKEN_ADDRESS)) {
    const { getBalance } = await import("./getBalance-ZKTOKR4F.js");
    return getBalance({
      address,
...
function useWalletImage(id) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { getInstalledWalletProviders: getInstalledWalletProviders2 } = await import("./mipdStore-VR2M5QX4.js");
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-A5UJI2J5.js.map
