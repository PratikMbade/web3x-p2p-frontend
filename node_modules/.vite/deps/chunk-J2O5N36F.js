import {
  ...
  createWalletEmitter,
  trackConnect
} from "./chunk-J4UBZBS7.js";
import {
  formatWalletConnectUrl,
  getWalletInfo
} from "./chunk-UL725LOM.js";
import {
  getCoinbaseWebProvider
} from "./chunk-DTFYEWTG.js";
import {
  isEcosystemWallet
...
} from "./chunk-XQN7MQ6W.js";
import {
  isContractDeployed
} from "./chunk-542HMRV2.js";
import {
  getSignPayload,
  toRpcList
} from "./chunk-5TWU5KEZ.js";
import {
  fromHex
} from "./chunk-D3EGTL52.js";
import {
  normalizeChainId
} from "./chunk-NNFEUBAJ.js";
import {
  isZkSyncChain
} from "./chunk-Y6KUSEHH.js";
import {
...
function baseAccountWalletSDK(args) {
  ...
  return {
    autoConnect: async (options) => {
      const { autoConnectBaseAccountSDK } = await import("./base-account-web-SKOGCPVO.js");
    ...
    connect: async (options) => {
      const { connectBaseAccountSDK } = await import("./base-account-web-SKOGCPVO.js");
      const provider = await args.providerFactory();
...
function coinbaseWalletSDK(args) {
  ...
  return {
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbase-web-AX5OCR3T.js");
      const provider = await args.providerFactory();
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbase-web-AX5OCR3T.js");
      const provider = await args.providerFactory();
...
function ecosystemWallet(...args) {
  ...
  return createInAppWallet({
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-MCBS2XYV.js");
...
function smartWallet(createOptions) {
  ...
  return {
    autoConnect: async (options) => {
      const { connectSmartAccount: connectSmartWallet } = await import("./smart-MUKUGOUG.js");
    ...
    connect: async (options) => {
      const { connectSmartAccount } = await import("./smart-MUKUGOUG.js");
    ...
    disconnect: async () => {
      if (account) {
        const { disconnectSmartAccount } = await import("./smart-MUKUGOUG.js");
...
function createWallet(...args) {
  ...
  switch (true) {
    ...
    default: {
      ...
      const wallet = {
        autoConnect: async (options) => {
          const { injectedProvider: injectedProvider2 } = await import("./mipdStore-VR2M5QX4.js");
          if (id !== "walletConnect" && injectedProvider2(id)) {
            const { autoConnectEip1193Wallet: autoConnectEip1193Wallet2 } = await import("./injected-AASE6JNC.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-SQICQXQY.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            var _a;
            const { connectWC } = await import("./controller-SQICQXQY.js");
            let qrOverlay;
            try {
          ...
          if (injectedProvider2(id) && !forceWalletConnectOption) {
            const { connectEip1193Wallet: connectEip1193Wallet2 } = await import("./injected-AASE6JNC.js");
...
//# sourceMappingURL=chunk-J2O5N36F.js.map
